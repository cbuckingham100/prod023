...
Module CBW
    ...
    '  File: CBW.BAS
    '
    '  (c) Copyright 1996 - 2006 by Measurement Computing Corp.
    '      All Rights Reserved
    '
    ...
    Public Const CURRENTREVNUM As Double = 5.7
    ' Error Codes
    ...
    Public Const INVALIDACCESS As Short = 163 ' Invalid access or privilege for specified operation
    Public Const UNAVAILABLE As Short = 164 ' Device unavailable at time of request. Please repeat operation.
    Public Const NOTREADY As Short = 165 ' Device is not ready to send data. Please repeat operation.
    Public Const BITUSEDFORALARM As Short = 169 ' The specified bit is used for alarm.
    Public Const PORTUSEDFORALARM As Short = 170 ' One or more bits on the specified port are used for alarm.
    Public Const PACEROVERRUN As Short = 171 ' Pacer overrun, external clock rate too fast.
    Public Const BADDEBOUNCETIME As Short = 177 ' Invalid debounce time specified.
    Public Const BADDEBOUNCETRIGMODE As Short = 178 ' Invalid debounce trigger mode specified.
    Public Const BADMAPPEDCOUNTER As Short = 179 ' Invalid mapped counter specified.
    ...
    Public Const NO_USB_BOARD As Short = 343 ' Specified USB board not detected
    Public Const NOMOREFILES As Short = 344 ' No more files in the directory
    Public Const BADFILENUMBER As Short = 345 ' Invalid file number
    Public Const INVALIDSTRUCTSIZE As Short = 346 ' Invalid structure size
    Public Const LOSSOFDATA As Short = 347 ' EOF marker not found, possible loss of data
    Public Const INVALIDBINARYFILE As Short = 348 ' File is not a valid MCC binary file
    ...
    Public Const NOSCALE As Short = 5
    ...
    Public Const FIRSTPORTC As Short = 12
    ...
    Public Const UNI4VOLTS As Short = 114 ' 0 to 4 Volts
    ...
    ' Counter status bits
    Public Const C_UNDERFLOW As Integer = &H1
    Public Const C_OVERFLOW As Integer = &H2
    Public Const C_COMPARE As Integer = &H4
    Public Const C_SIGN As Integer = &H8
    Public Const C_ERROR As Integer = &H10
    Public Const C_UP_DOWN As Integer = &H20
    Public Const C_INDEX As Integer = &H40

    ' 25xx series counter mode constants
    Public Const TOTALIZE As Integer = &H0
    Public Const CLEAR_ON_READ As Integer = &H1
    Public Const ROLLOVER As Integer = &H0
    Public Const STOP_AT_MAX As Integer = &H2
    Public Const DECREMENT_OFF As Integer = &H0
    Public Const DECREMENT_ON As Integer = &H20
    Public Const BIT_16 As Integer = &H0
    Public Const BIT_32 As Integer = &H4
    Public Const GATING_OFF As Integer = &H0
    Public Const GATING_ON As Integer = &H10

    ' 25xx series counter debounce time constants
    Public Const DEBOUNCE500ns As Short = 0
    Public Const DEBOUNCE1500ns As Short = 1
    Public Const DEBOUNCE3500ns As Short = 2
    Public Const DEBOUNCE7500ns As Short = 3
    Public Const DEBOUNCE15500ns As Short = 4
    Public Const DEBOUNCE31500ns As Short = 5
    Public Const DEBOUNCE63500ns As Short = 6
    Public Const DEBOUNCE127500ns As Short = 7
    Public Const DEBOUNCE100us As Short = 8
    Public Const DEBOUNCE300us As Short = 9
    Public Const DEBOUNCE700us As Short = 10
    Public Const DEBOUNCE1500us As Short = 11
    Public Const DEBOUNCE3100us As Short = 12
    Public Const DEBOUNCE6300us As Short = 13
    Public Const DEBOUNCE12700us As Short = 14
    Public Const DEBOUNCE25500us As Short = 15
    Public Const DEBOUNCE_NONE As Short = 16

    ' 25xx series counter debounce trigger constants
    Public Const CTR_TRIGGER_AFTER_STABLE As Short = 0
    Public Const CTR_TRIGGER_BEFORE_STABLE As Short = 1

    ' 25xx series counter edge detection constants
    Public Const CTR_RISING_EDGE As Short = 0
    Public Const CTR_FALLING_EDGE As Short = 1
    ...
    ' --Connections
    Public Const AUXIN0 As Integer = &H1
    Public Const AUXIN1 As Integer = &H2
    Public Const AUXIN2 As Integer = &H4
    Public Const AUXIN3 As Integer = &H8
    Public Const AUXIN4 As Integer = &H10
    Public Const AUXIN5 As Integer = &H20

    Public Const AUXOUT0 As Integer = &H100
    Public Const AUXOUT1 As Integer = &H200
    Public Const AUXOUT2 As Integer = &H400

    Public Const DS_CONNECTOR As Integer = &H1000

    Public Const MAX_CONNECTIONS As Integer = 4 'maximum  number connections per output signal

    ' --Signal Types
    Public Const ADC_CONVERT As Integer = &H1
    Public Const ADC_GATE As Integer = &H2
    Public Const ADC_START_TRIG As Integer = &H4
    Public Const ADC_STOP_TRIG As Integer = &H8
    Public Const ADC_TB_SRC As Integer = &H10
    ...
    Public Const BIDIALARMMASK As Short = 230
    Public Const BIDIDEBOUNCESTATE As Short = 255
    Public Const BIDIDEBOUNCETIME As Short = 256 ' Digital inputs debounce Time
    ...
    Public Const ON_CHANGE_DI As Integer = &H40
...
#If Win32 Then
    ...
    Public Const NONSTREAMEDIO As Integer = &H40000 ' Non-streamed D/A output
    Public Const ADCCLOCKTRIG As Integer = &H80000
    ...
    ' time zone constants
    Public Const TIMEZONE_LOCAL As Short = 0
    Public Const TIMEZONE_GMT As Short = 1


    ' time format constants
    Public Const TIMEFORMAT_12HOUR As Short = 0
    Public Const TIMEFORMAT_24HOUR As Short = 1


    ' delimiter constants
    Public Const DELIMITER_COMMA As Short = 0
    Public Const DELIMITER_SEMICOLON As Short = 1
    Public Const DELIMITER_SPACE As Short = 2
    Public Const DELIMITER_TAB As Short = 3


    ' Data Logger units constants
    Public Const UNITS_TEMPERATURE As Short = 0
    Public Const UNITS_RAW As Short = 1
    '
    ...
    'UPGRADE_NOTE: TimeOfDay was upgraded to TimeOfDay_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
    ...
    Declare Function cbEnableEvent Lib "cbw32.dll" (ByVal BoardNum As Integer, ByVal EventType As Integer, ByVal EventSize As Integer, ByVal Callback As Integer, <MarshalAsAttribute(UnmanagedType.AsAny)> ByRef UserData As Object) As Integer
    ...
    Declare Function cbLogSetPreferences Lib "cbw32.dll" (ByVal TimeFormat As Integer, ByVal TimeZone As Integer, ByVal Units As Integer) As Integer
    Declare Function cbLogGetPreferences Lib "cbw32.dll" (ByRef TimeFormat As Integer, ByRef TimeZone As Integer, ByRef Units As Integer) As Integer
    Declare Function cbLogGetFileName Lib "cbw32.dll" (ByVal FileNum As Integer, ByVal Path As String, ByVal Filename As String) As Integer
    Declare Function cbLogGetFileInfo Lib "cbw32.dll" (ByVal Filename As String, ByRef Version As Integer, ByRef Size As Integer) As Integer
    Declare Function cbLogGetSampleInfo Lib "cbw32.dll" (ByVal Filename As String, ByRef SampleInterval As Integer, ByRef SampleCount As Integer, ByRef StartDate As Integer, ByRef StartTime As Integer) As Integer
    Declare Function cbLogGetAIChannelCount Lib "cbw32.dll" (ByVal Filename As String, ByRef AIChannelCount As Integer) As Integer
    Declare Function cbLogGetAIInfo Lib "cbw32.dll" (ByVal Filename As String, ByRef ChannelNumbers As Integer, ByRef Units As Integer) As Integer
    Declare Function cbLogGetCJCInfo Lib "cbw32.dll" (ByVal Filename As String, ByRef CJCChannelCount As Integer) As Integer
    Declare Function cbLogGetDIOInfo Lib "cbw32.dll" (ByVal Filename As String, ByRef DIOChannelCount As Integer) As Integer
    Declare Function cbLogReadTimeTags Lib "cbw32.dll" (ByVal Filename As String, ByVal StartSample As Integer, ByVal SampleCount As Integer, ByRef Dates As Integer, ByRef Times As Integer) As Integer
    Declare Function cbLogReadAIChannels Lib "cbw32.dll" (ByVal Filename As String, ByVal StartSample As Integer, ByVal SampleCount As Integer, ByRef AIChannelData As Single) As Integer
    Declare Function cbLogReadCJCChannels Lib "cbw32.dll" (ByVal Filename As String, ByVal StartSample As Integer, ByVal SampleCount As Integer, ByRef CJCChannelData As Single) As Integer
    Declare Function cbLogReadDIOChannels Lib "cbw32.dll" (ByVal Filename As String, ByVal StartSample As Integer, ByVal SampleCount As Integer, ByRef DIOChannelData As Integer) As Integer
    Declare Function cbLogConvertFile Lib "cbw32.dll" (ByVal Filename As String, ByVal DestFilename As String, ByVal StartSample As Integer, ByVal SampleCount As Integer, ByVal Delimiter As Integer) As Integer
